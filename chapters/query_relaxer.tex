...
In questo package sono contenuti diversi moduli divisi in baso al loro scopo.
...
Non saranno fornite particolari informazioni su questa classe , in quanto essa fa semplicemente da wrapping all'algoritmo di ricerca di RFD , per ulteriori informazioni si veda \cite{tesinaIA}